...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('documents_documentversion', 'user', self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True), keep_default=False)
        db.add_column('documents_documentversion', 'user_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'DocumentVersion.signature_state'
        db.delete_column('documents_documentversion', 'user')
        db.delete_column('documents_documentversion', 'user_id')
